<%-- 
    Document   : index
    Created on : Jun 5, 2022, 10:22:03 AM
    Author     : ngt
--%>
...
<p>Click <a href="${loginUrl}">here</a> to see a greeting.</p>
		    ...
		    <div id="section-overview" class="section-overview section pt-md-4 pt-lg-5">
		        <div class="container py-5">
			        <div class="section-col-max mx-auto">
				        <h3 class="section-title mb-4">What We are About</h3>
			            <p class="mb-4">We are a software solutions company with distinct world-class Technology solutions. Our products and services brings high values to our client business and we support and build enterprise scale java base web applications for wide range of business sector from Health environment , E-commerce web based Applications to Fintech Apps..</p>
				        ...
				        <div class="row over-section-bg">
					        <div class="col-12 col-lg-3">
						        <div class="tutor-img-holder mb-5 mb-lg-0 text-center">
							        <img class="tutor-profile img-fluid rounded" src="images/tutor2.jpg" alt="">
				            ...
				            <div class="col-12 col-lg-6 mb-4 mb-lg-0">
					            <div class="plan-item rounded">
						            ...
						            <div class="plan-cta text-center px-4">
							            <a class="btn btn-ghost btn-block" href="#" target="_blank">Join Free</a>
							        </div>
					            </div><!--//plan-item-->
				            </div><!--//col-->
				            <div class="col-12 col-lg-6 mb-4 mb-lg-0">
					            <div class="plan-item rounded">
						            ...
						            <div class="plan-cta text-center px-4">
							             <a class="btn btn-primary btn-block" href="#" target="_blank">Enroll Now</a>
							        </div>
					            </div><!--//plan-item-->
				            </div><!--//col-->
			            </div><!--//row-->
		        ...
		        <div class="container">
			        <div class="container-inner p-5 position-relative theme-bg-primary rounded text-white">
				        ...
				        <div class="section-col-max mx-auto over-section-bg">
				            ...
				            <div class="profile-holder mb-3"><img class="profile-image" src="images/tutor2.jpg" alt="image"></div>
                                            <p class="intro">Want to hire us for your staff training or speaking at your conference? <br> Find us here Etech Consulting LLC
                <br>4291 Beverly Hills Dr, Brunswick
                 <br>Ohio,44212,USA <br> and You can email our team at <a  href="#">infos@etechconsultllc.com/
                                                        enkengafac@etechconsultllc.com</a><br> or phone our team here + 1 347873512/ +1 6677868741</p>
		                    <h5 class="intro text-white">Know someone who may find the course useful?</h5>
			                <div>Please help us spread the word! :)</div>
